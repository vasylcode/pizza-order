...
function CartItem({ id, image, name, type, size, totalPrice, totalCount, onRemove }) {
    ...
    return (
        <div className="cart__item">
            ...
            <div className="cart__item-info">
                ...
                <div className="cart__item-params">{type}, {size} cm.</div>
            </div>
            <div className="cart__item-count">x{totalCount}</div>
            <div className="cart__item-clear" onClick={handleRemoveClick}>
